...
RU_SYMBOLS = [
    ...
    "æ", "ç", "ð", "ŋ", "ɐ", "ɑ", "ɔ", "ɕ", "ə", "ɛ", "ɜ", "ɡ", "ɪ", "ɭ", "ɵ", "ʃ", "ʊ", "ʌ", "ʑ", "ʒ", "ʐ", "ʲ", "ː", "ɨ", "ʂ", "tɕ"
]

NUM_RU_TONES = 2

# Combine all symbols
NORMAL_SYMBOLS = sorted(set(ZH_SYMBOLS + JP_SYMBOLS + EN_SYMBOLS + RU_SYMBOLS))
SYMBOLS = [PAD] + NORMAL_SYMBOLS + PUNCTUATION_SYMBOLS
SIL_PHONEMES_IDS = [SYMBOLS.index(i) for i in PUNCTUATION_SYMBOLS]

# Combine all tones
NUM_TONES = NUM_ZH_TONES + NUM_JP_TONES + NUM_EN_TONES + NUM_RU_TONES

# Language maps
LANGUAGE_ID_MAP = {"ZH": 0, "JP": 1, "EN": 2, "RU": 3}
...
LANGUAGE_TONE_START_MAP = {
    ...
    "RU": NUM_ZH_TONES + NUM_JP_TONES + NUM_EN_TONES,
}
